...
import com.example.seeingthings.camera.CompareSizesByArea
import com.example.seeingthings.tflite.RealTimeClassifier
import com.example.seeingthings.ui.dialog.ConfirmationDialog
import com.example.seeingthings.ui.dialog.ErrorDialog
import com.example.seeingthings.utils.ImageConversion
import com.example.seeingthings.utils.PIC_FILE_NAME
import com.example.seeingthings.utils.REQUEST_CAMERA_PERMISSION
import com.example.seeingthings.utils.showToast
import java.io.File
import java.util.*
...
class RealTimeRecognitionFragment : Fragment(), View.OnClickListener,
    ActivityCompat.OnRequestPermissionsResultCallback {

    private lateinit var realTimeRecogViewModel: RealTimeRecogViewModel
    ...
    override fun onCreateView(
        ...
        realTimeRecogViewModel =
                ViewModelProviders.of(this).get(RealTimeRecogViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_realtime_recognition, container, false)
        realTimeRecogViewModel.text.observe(viewLifecycleOwner, Observer {
        })
        return root
    }
    ...
    object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@RealTimeRecognitionFragment.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@RealTimeRecognitionFragment.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@RealTimeRecognitionFragment.activity?.finish()
        }
    }
...
//                LOGGER.d("Initializing buffer %d at size %d", i, buffer.capacity())
    ...
    private lateinit var realTimeClassifier: RealTimeClassifier
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        titleTextView.setText(R.string.title_realtime )
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        realTimeClassifier = RealTimeClassifier(requireActivity().assets, mModelPath, mLabelPath, mInputSize)
    ...
    private fun openCamera(width: Int, height: Int) {
        val permission = ContextCompat.checkSelfPermission(this.requireContext(), Manifest.permission.CAMERA)
...
//            LOGGER.i("Opening camera preview: " + previewSize.width + "x" + previewSize.height)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(): RealTimeRecognitionFragment = newInstance()
    }
            ...
            try {
                ...
                if (isProcessingFrame) {
                    ...
                    imageConverter = Runnable {
                        ImageConversion.convertYUV420ToARGB8888(
                            yuvBytes[0],
                            yuvBytes[1],
                            yuvBytes[2],
                            previewSize.width,
                    ...
                    val results = rgbFrameBitmap?.let { it1 -> realTimeClassifier.recognizeImage(it1) }
