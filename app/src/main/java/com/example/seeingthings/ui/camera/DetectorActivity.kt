...
import com.example.seeingthings.camera.OverlayView
import com.example.seeingthings.tflite.Classifier
import com.example.seeingthings.tflite.TFLiteObjectDetectionAPIModel
import com.example.seeingthings.tracking.MultiBoxTracker
...
//        LOGGER.i("Camera orientation relative to screen canvas: %d", sensorOrientation.toString())
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(): DetectorActivity = newInstance()
    }
}
